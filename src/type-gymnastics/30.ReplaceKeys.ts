...
type ReplaceKeys<U extends {}, T extends string, Y extends {}> = { [K in keyof U]: K extends T ? K extends keyof Y ? Y[K] : never : U[K] }

type res = ReplaceKeys<Nodes, 'name', { aa: number }>
